...
const config: Config = {
  ...
  tagline: "Learn World of Warcraft PvP",
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: `https://github.com/jackLDyer/built-diff-guides/tree/main/`,
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            {
              label: "Discord",
              href: "https://discord.gg/2tdA2zGzkJ",
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Built Diff Guides. Built with Docusaurus.`,
    },
    prism: {
